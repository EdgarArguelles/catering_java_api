...
import com.catering.repositories.AuthenticationRepository;
import com.catering.repositories.PersonRepository;
import com.catering.repositories.RoleRepository;
import com.catering.security.factories.LoggedUserFactory;
import com.catering.security.pojos.LoggedUser;
import com.catering.security.services.OAuthService;
...
public class OAuthServiceImplTest {
    ...
    public void parseFacebookUserWithNullAuthenticationDefaultValues() {
        ...
        given(roleRepository.findByName("CLIENT")).willReturn(role);
