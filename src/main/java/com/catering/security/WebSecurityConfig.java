...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public static final List<String> ALLOWED_ORIGINS = List.of(
            ...
            "http://cateringreactclientqa.herokuapp.com", "https://cateringreactclientqa.herokuapp.com",
            "http://cateringreactclient.herokuapp.com", "https://cateringreactclient.herokuapp.com");
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .antMatchers(HttpMethod.GET, "/swagger-ui.html", "/swagger-ui/**", "/v3/**").permitAll()
